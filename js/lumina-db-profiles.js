...
export const PROFILES_DB = {
    ...
    'ccwomen': {
        ...
        denom: 'Chrześcijańskie',
        status: 'Kanał YouTube CC Women',
        pin: '7777',
        visibility: 'public',
        match: '100%',
        matchScore: '100%',
        isMissionAccount: true,
        stats: { friends: '890', posts: '12', likes: '1.9k' },
        verse: '„Niewiastę dzielną któż znajdzie? Jej wartość przewyższa perły.”',
        verseRef: '— Księga Przysłów 31, 10',
        bio: 'Oficjalny kanał YouTube CC Women. Tworzymy przestrzeń dla kobiet poszukujących Bożej mądrości, głębokich relacji i duchowego wzrostu.',
        tags: ['Kobiety Wiary', 'CC Women', 'Mądrość', 'Czystość', 'Małżeństwo', 'YouTube'],
        ...
        posts: [
            {
                ...
                authorRole: 'Kanał YouTube CC Women 🌸',
                time: 'Przedwczoraj • 🌸 Premiera Wideo',
                text: 'Drogie Kobiety Wiary! Nowe nagranie z serii „Niewiasta Dzielna” jest już dostępne na kanale CC Women! Zapraszamy do budowania serca przy Chrystusie. 🕊️',
                likes: 47,
                amen: 39,
                image: null
            }
