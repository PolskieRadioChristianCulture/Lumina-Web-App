...
export const OMNI_BASE_PROFILES = [
    ...
    },
    {
        ...
        handle: '@sds',
        aliases: ['studio dobrego slowa', 'studiods', 'studiods.pl', 'studiodees', 'apokalipsa live', 'herbatka miedzy slowami', 'herbatka', 'herbaciarnia', 'pila', 'podcast'],
        city: 'Piła, Polska',
        job: 'Kanał YouTube @StudioDeeS • studiods.pl 🎙️',
        bio: 'Oficjalny profil Studia. Apokalipsa Live, podcasty, Słowo Boże i herbaciarnia „Herbatka między słowami”.',
