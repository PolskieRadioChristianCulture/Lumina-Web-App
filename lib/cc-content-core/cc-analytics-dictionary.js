...
/**
 * Pobiera definicję metryki ze słownika (domyślnie v2, z fallbackiem do v1)
 * @param {string} metricName
 * @param {'v1' | 'v2'} [version='v2']
 * @returns {MetricDefinition}
 */
export function getMetricDefinition(metricName, version = 'v2') {
    const norm = (metricName || '').toUpperCase();
    const dict = (version === 'v1') ? CC_ANALYTICS_DICTIONARY : CC_ANALYTICS_DICTIONARY_V2;
